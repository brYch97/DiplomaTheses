    ...
    export interface StandardControl<TInputs, TOutputs> {
         ...
         * 'setControlState' in the Mode export interface.
    ...
    /**
     * export interface for Power Apps React controls
     */
     export interface ReactControl<TInputs, TOutputs> extends StandardControl<TInputs, TOutputs> {
        /**
         * Called when any value in the property bag has changed. This includes field values, data-sets, global values such as container height and width,
         * offline status, control metadata values such as label, visible, etc.
         * @param context The entire property bag available to control via Context Object; It contains values as set up by the customizer mapped to names
    ...
    /**
     * The entire property bag export interface available to control via Context Object
     */
    export interface Context<TInputs> {
        client: Client;
        device: Device;
        factory: Factory;
    ...
    /**
     * The export interface for the context.client
     */
    export interface Client {
         ...
         * Web: Web application, or Unified export interface
         * Outlook: Outlook
         * Mobile: Mobile app
         */
        getClient(): string;
    ...
    /**
     * The export interface for the context.device
     */
    export interface Device {
        /**
         * Invokes the device microphone to record audio.
         */
        captureAudio(): FileObject

        /**
         * Invokes the device camera to capture an image.
         */
        captureImage(options?: CaptureImageOptions): FileObject

        /**
         * Invokes the device camera to record video.
         */
        captureVideo(): FileObject
         ...
         */
        pickFile(options?: PickFileOptions): FileObject[]
    }

    /**
     * The export interface for the context.factory
     */
    ...
    /**
     * The export interface for the context.formatting
     */
    ...
    /**
     * The export interface for the context.mode
     */
    ...
    /**
     * The navigation export interface of context.navigation
     */
    export interface Navigation {
         ...
         */
        openAlertDialog(alertStrings: AlertDialogStrings, options?: AlertDialogOptions): void
         ...
         */
        openConfirmDialog(confirmStrings: ConfirmDialogStrings, options?: ConfirmDialogOptions): ConfirmDialogResponse
         ...
         * @returns promise defining success or failure of operation.
         */
        openErrorDialog(options: ErrorDialogOptions): void
         ...
         * @returns promise defining success or failure of operation.
         */
        openFile(file: FileObject, options?: OpenFileOptions): void
         ...
         * @returns promise defining success or failure of operation
         */
        openForm(options: EntityFormOptions, parameters?: {[key: string]: string}): OpenFormSuccessResponse
    ...
    /**
     * The resource export interface of context.resources
     */
    ...
    /**
     * The export interface for context.userSettings
     */
    ...
    /**
     * The export interface for context.utils
     */
    export interface Utility {
         ...
         */
        getEntityMetadata(entityName: string, attributes?: string[]): EntityMetadata
         ...
         */
        hasEntityPrivilege(entityTypeName: string, privilegeType: PrivilegeType, privilegeDepth: PrivilegeDepth): boolean;
         ...
         */
        lookupObjects(lookupOptions: LookupOptions): LookupValue[]
    }

    /**
     * The export interface for context.webApi
     */
    export interface WebApi {
         ...
         */
        createRecord(entityType: string, data: Entity): LookupValue
         ...
         */
        deleteRecord(entityType: string, id: string): LookupValue
         ...
         */
        updateRecord(entityType: string, id: string, data: Entity): LookupValue
         ...
         * @returns The deferred object for the result of the operation. An object with export interface RetrieveMultipleResponse will be resolved if successful.
         */
        retrieveMultipleRecords(entityType: string, options?: string, maxPageSize?: number): RetrieveMultipleResponse
         ...
         */
        retrieveRecord(entityType: string, id: string, options?: string): Entity
    }

    //////////////// Define namespace of each context first-level child export interface's helper ////////////////
    ...
    /**
     * Helper of Device API export interface
     */
        ...
        /**
         * export interface of return geological information in context.device.getCurrentPosition
         */
        ...
        /**
         * export interface of input argument 'pickupFileOption' in context.device.pickupFile
         */
        export interface PickFileOptions {
            /**
             * Image file to select. Valid values are "audio", "video", or "image".
             */
            accept: string;
    ...
    /**
     * Helper of Factory Pop API export interface
     */
        export interface PopupService {
            /**
             * Create a new popup element
             * @param props The popup properties object, see Popup export interface for more
             */
    ...
    /**
     * Helper of Formatting API export interface
     */
        /**
    ...
    /**
     * Helper of Navigation API export interface
     */
        /**
         * export interface for alert dialog options.
         */
        ...
        /**
         * export interface for confirm dialog options.
         */
        ...
        /**
         * export interface for entity form options.
         */
        ...
        /**
         * export interface for error dialog options.
        ...
        /**
         * export interface for open file options.
         */
         ...
         */
        export interface OpenFormSuccessResponse {
            savedEntityReference: LookupValue[];
        }

        /**
         * export interface for OpenUrl options.
         */
        ...
        /**
         * export interface for OpenWebResource options.
         */
    ...
    /**
     * Helper of UserSettings API export interface
     */
            /**
             * Day Of Week Enum
             * 0 - Sunday,
        ...
        /**
         * The export interface for Org Date Format Info exposed to a custom control
        ...
        export interface DateFormattingInfo {
            ...
            /**
             * @example See export interface Calendar
             */
            calendar: Calendar;
            ...
            /**
             * @example See export interface DayOfWeek
             */
        ...
        /**
         * The export interface for the Org System Settings Number Format Info exposed to a custom control
        ...
        /**
         * The export interface for the Calendar exposed in DateFormattingInfo
         */
    ...
    /**
     * Helper of Utils API export interface
     */
        /**
     ...
     */
        /**
         * export interface that describes an entity sent or received from the SDK through the Web API.
         */
    ...
    /**
     * export interface of one file object
     */
...
///////////////////// Parameter ////////////////////////
        ...
        /**
         * export interface for context.parameters.[property_key]
         */
        ...
        /**
         * Property export interface for context.parameters.[property_key], when property manifest type is Whole.None|FP|Decimal
         */
        export interface NumberProperty extends Property {
            raw: number | null;
            attributes?: NumberMetadata | undefined;
        }

        /**
         * Property export interface for context.parameters.[property_key], when property manifest type is Decimal
         */
        export interface DecimalNumberProperty extends NumberProperty {
            attributes?: DecimalNumberMetadata | undefined;
        }

        /**
         * Property export interface for context.parameters.[property_key], when property manifest type is FP
         */
        export interface FloatingNumberProperty extends NumberProperty {
            attributes?: FloatingNumberMetadata | undefined;
        }

        /**
         * Property export interface for context.parameters.[property_key], when property manifest type is Whole.None
         */
        export interface WholeNumberProperty extends NumberProperty {
            attributes?: WholeNumberMetadata | undefined;
        }

        /**
         * Property export interface for context.parameters.[property_key], when property manifest type starts from DateTime
         */
        export interface DateTimeProperty extends Property {
            raw: Date | null;
            attributes?: DateTimeMetadata | undefined;
        }

        /**
         * Property export interface for context.parameters.[property_key], when property manifest type starts from SingleLine
         */
        export interface StringProperty extends Property {
            raw: string | null;
            attributes?: StringMetadata | undefined;
        }

        /**
         * Property export interface for context.parameters.[property_key], when property manifest type is Enum
         */
        export interface EnumProperty<EnumType> {
            type: string;
            raw: EnumType;
        }

        /**
         * Property export interface for context.parameters.[property_key], when property manifest type is OptionSet
         */
        export interface OptionSetProperty extends Property {
            raw: number | null;
            attributes?: OptionSetMetadata | undefined;
        }

        /**
         * Property export interface for context.parameters.[property_key], when property manifest type is MultiSelectOptionSet
         */
        export interface MultiSelectOptionSetProperty extends Property {
            raw: number[] | null;
            attributes?: OptionSetMetadata | undefined;
        }

        /**
         * Property export interface for context.parameters.[property_key], when property manifest type is TwoOptions
         */
        export interface TwoOptionsProperty extends Property {
            raw: boolean;
            attributes?: TwoOptionMetadata | undefined;
        }

        /**
         * Property export interface for context.parameters.[property_key], when property manifest type is Lookup. Currently
         * targeted for use with Lookup.Simple only, and export interface will be expanded as more features are made public.
         */
        export interface LookupProperty extends Property {
            raw: LookupValue[];
        ...
        /**
         * For full list of attributes, please refer to documentation
        ...
        export interface SecurityValues {
            ...
            export interface FloatingNumberMetadata extends NumberMetadata {
                Precision: number;
            }

            export interface DecimalNumberMetadata extends NumberMetadata {
                Precision: number;
            }

            export interface WholeNumberMetadata extends NumberMetadata {
                Format: string;
                LanguageByCode?: Dictionary | undefined;
                TimeZoneByCode?: Dictionary | undefined;
            }

            export interface DateTimeMetadata extends Metadata {
                Behavior: DateTimeFieldBehavior;
                Format: string;
                ImeMode: ImeMode;
            }

            export interface LookupMetadata extends Metadata {
                Targets: string[];
            }
            ...
            export interface OptionSetMetadata extends Metadata {
                Options: OptionMetadata[];
                DefaultValue: number;
            }

            export interface TwoOptionMetadata extends Metadata {
            ...
            /**
             * Base export interface for dataset record result. Supports value retrival by column name.
             */
             ...
             */
            export interface LinkEntityExposedExpression {
                /**
